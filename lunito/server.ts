...
// Direct fallback configuration to ensure the app remains fully functional
// when deployed to Vercel or environment configurations are not present.
if (!process.env.GEMINI_API_KEY) {
  process.env.GEMINI_API_KEY = "AIzaSyBem733mcKjQFJTdgAUA_dTf5CHB98HzAw";
}

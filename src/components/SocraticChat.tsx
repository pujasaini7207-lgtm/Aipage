          ...
          <div className="flex-1 min-h-[420px] p-5 rounded-xl bg-white border border-[#E5E5E5] flex flex-col justify-between overflow-hidden relative shadow-none">
            ...
            <div className="flex-1 overflow-y-auto pr-2 space-y-6 max-h-[480px]">
              {isLoadingMessages ? (
                ...
                <div className="h-full flex flex-col items-center justify-center py-20 text-center space-y-5 max-w-md mx-auto">
                  <div className="p-5 bg-gradient-to-br from-emerald-50 to-emerald-100/50 rounded-2xl text-[#10A37F] shadow-sm">
                    <Brain className="w-11 h-11" />
                  </div>
                  <div className="space-y-2">
                    <h2 className="text-2xl font-extrabold text-[#111111] font-display tracking-tight">
                      Lunito AI
                    </h2>
                    <p className="text-[11px] font-bold uppercase tracking-widest text-[#10A37F] font-mono">
                      Target Syllabus Module: {selectedTopic}
                    </p>
                    <p className="text-xs text-[#666666] mt-1.5 leading-relaxed">
                      Primed under official curriculum guidelines. Submit a question, formula, or code block to launch a constructive intellectual tutoring dialog!
                    </p>
                  </div>
                </div>
              ) : (

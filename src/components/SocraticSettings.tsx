...
import { Settings, User, CreditCard, Sparkles, Sliders, Bell, LogOut } from "lucide-react";
...
export const SocraticSettings: React.FC<SocraticSettingsProps> = ({
  ...
  return (
    ...
    >
      ...
      <div className="p-6 rounded-xl border border-red-100 bg-red-50/30 space-y-3 shadow-none">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
          <p className="text-[11px] text-[#666666] leading-relaxed max-w-sm">
            Signing out will end your current session and return you to the Lunito landing page.
          </p>
          <button
            onClick={onLogout}
            className="px-4 py-2 bg-white hover:bg-red-500 border border-red-200 hover:border-red-500 text-red-500 hover:text-white text-xs font-semibold rounded-lg transition-all cursor-pointer flex items-center justify-center gap-1.5 shrink-0"
          >
